...
import { CanDeactivateFormBuilder } from './form-builder-dialog.guard';
...
describe('CanDeactivateFormBuilder', () => {
  let formBuilderGuard: CanDeactivateFormBuilder<MockComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [CanDeactivateFormBuilder, provideMock(Router)],
    });

    formBuilderGuard = TestBed.inject(CanDeactivateFormBuilder);
  });
