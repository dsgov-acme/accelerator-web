...
export class FormBuilderService {
  ...
  constructor(private readonly _workApiRoutesService: WorkApiRoutesService, private readonly _formTransactionService: FormTransactionService) {}
  ...
  public getFormConfigurationByKey$(transactionDefinitionKey: string, key: string): Observable<FormioForm> {
    ...
    return this.processFormConfigurationObservable(observable, transactionDefinitionKey, key);
  }

  private processFormConfigurationObservable(_observable$: Observable<IForm>, transactionDefinitionKey: string, key: string): Observable<FormioForm> {
    return _observable$.pipe(
      map(formConfigurationWrapper => {
        ...
        this._formTransactionService.setFormConfiguration(formConfigurationModel);
