...
import { DashboardCategoriesMock, DashboardService } from '@dsg/employer/feature/dashboard';
...
import { NuverialMenuOptions, NuverialSideNavMenuComponent } from '@dsg/shared/ui/nuverial';
...
const dependencies = MockBuilder(ShellComponent)
  ...
  .mock(DashboardService, {
    getDashboardCategories: jest.fn().mockImplementation(() => DashboardCategoriesMock),
  })
  .provide(
    MockProvider(Router, {
...
describe('ShellComponent', () => {
  ...
  it('should get the menu items', async () => {
    ...
    const menuItemList = DashboardCategoriesMock.map(category => ({
      icon: category.icon,
