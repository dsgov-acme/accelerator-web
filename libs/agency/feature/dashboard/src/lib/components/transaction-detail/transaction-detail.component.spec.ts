...
describe('TransactionDetailComponent', () => {
  ...
  it('should set the formControls when the transaction is updated', () => {
    ...
    const tabs: INavigableTab[] = [
      { key: 'details', label: 'Detail', route: `/dashboard/transaction/${transactionModelMock.id}` },
      { key: 'notes', label: 'Notes', route: `/dashboard/transaction/${transactionModelMock.id}/notes` },
      { key: 'events', label: 'Activity Log', route: `/dashboard/transaction/${transactionModelMock.id}/events` },
    ];
